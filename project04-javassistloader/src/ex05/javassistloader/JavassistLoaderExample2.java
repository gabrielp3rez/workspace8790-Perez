...
public class JavassistLoaderExample2 {
   ...
   public static void main(String[] args) throws Exception {
      ...
      addMethodCall(cp, cc, "10");
      executeMethodCall(cp);

      cc.defrost();
      addMethodCall(cp, cc, "20");
      executeMethodCall(cp);
   }
   ...
   static void addMethodCall(ClassPool cp, CtClass cc, String valX) throws Exception {
